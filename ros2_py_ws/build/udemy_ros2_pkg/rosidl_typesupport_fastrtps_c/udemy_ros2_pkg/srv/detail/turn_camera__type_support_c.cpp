...
#include "udemy_ros2_pkg/srv/detail/turn_camera__rosidl_typesupport_fastrtps_c.h"
...
using _TurnCamera_Request__ros_msg_type = udemy_ros2_pkg__srv__TurnCamera_Request;
...
size_t get_serialized_size_udemy_ros2_pkg__srv__TurnCamera_Request(
  const void * untyped_ros_message,
...
static uint32_t _TurnCamera_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_udemy_ros2_pkg__srv__TurnCamera_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_udemy_ros2_pkg
size_t max_serialized_size_udemy_ros2_pkg__srv__TurnCamera_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _TurnCamera_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_udemy_ros2_pkg__srv__TurnCamera_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, udemy_ros2_pkg, srv, TurnCamera_Request)() {
...
using _TurnCamera_Response__ros_msg_type = udemy_ros2_pkg__srv__TurnCamera_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_udemy_ros2_pkg
size_t get_serialized_size_udemy_ros2_pkg__srv__TurnCamera_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TurnCamera_Response__ros_msg_type * ros_message = static_cast<const _TurnCamera_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_udemy_ros2_pkg__srv__TurnCamera_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_udemy_ros2_pkg
size_t max_serialized_size_udemy_ros2_pkg__srv__TurnCamera_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _TurnCamera_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_udemy_ros2_pkg__srv__TurnCamera_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, udemy_ros2_pkg, srv, TurnCamera_Response)() {
...
// already included above
// #include "udemy_ros2_pkg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "udemy_ros2_pkg/srv/turn_camera.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, udemy_ros2_pkg, srv, TurnCamera)() {
