...
class Metaclass_TurnCamera(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from udemy_ros2_pkg.srv import _turn_camera
...
class TurnCamera(metaclass=Metaclass_TurnCamera):
    from udemy_ros2_pkg.srv._turn_camera import TurnCamera_Request as Request
    from udemy_ros2_pkg.srv._turn_camera import TurnCamera_Response as Response
